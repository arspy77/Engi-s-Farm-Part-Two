...
public class CowTest {
    ...
    public void ctor() {
        ...
        FarmAnimal anima = new Cow(pos, map, 10, 11);
    ...
    public void produceProduct() {
        ...
        anima.tick();
        assertEquals(Product.Category.COWMEAT, anima.produceProduct(FarmAnimal.Action.KILL).getCategory());
    }
    ...
    public void makeNoise() {
        ...
        Matrix<Cell> map = new Matrix<Cell>(10, 11, new Coop());
        FarmAnimal anima = new Cow(pos, map, 10, 11);
        assertEquals("mo~ mo~", anima.makeNoise());
    }

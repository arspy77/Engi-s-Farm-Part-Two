...
public class DuckTest {
    ...
    public void ctor() {
        ...
        FarmAnimal anima = new Duck(pos, map, 10, 11);
    ...
    public void produceProduct() {
        ...
        anima.tick();
        assertEquals(Product.Category.DUCKMEAT, anima.produceProduct(FarmAnimal.Action.KILL).getCategory());
    }
    ...
    public void makeNoise() {
        ...
        Matrix<Cell> map = new Matrix<Cell>(10, 11, new Coop());
        FarmAnimal anima = new Duck(pos, map, 10, 11);
        assertEquals("ga~ ga~", anima.makeNoise());
    }

...
public class PigTest {
    ...
    public void ctor() {
        ...
        FarmAnimal anima = new Pig(pos, map, 10, 11);
    ...
    public void produceProduct() {
        ...
        anima.tick();
        assertEquals(Product.Category.PIGMEAT, anima.produceProduct(FarmAnimal.Action.KILL).getCategory());
    }
    ...
    public void makeNoise() {
        ...
        Matrix<Cell> map = new Matrix<Cell>(10, 11, new Coop());
        FarmAnimal anima = new Pig(pos, map, 10, 11);
        assertEquals("bu~ bu~", anima.makeNoise());
    }

...
public class ChickenTest {
    ...
    public void ctor() {
        ...
        FarmAnimal anima = new Chicken(pos, map, 10, 11);
    ...
    public void produceProduct() {
        ...
        anima.tick();
        assertEquals(Product.Category.CHICKENEGG, anima.produceProduct(FarmAnimal.Action.INTERACT).getCategory());
    }
    ...
    public void makeNoise() {
        ...
        Matrix<Cell> map = new Matrix<Cell>(10, 11, new Coop());
        FarmAnimal anima = new Chicken(pos, map, 10, 11);
        assertEquals("kokekokko~", anima.makeNoise());
    }

...
public class OwlTest {
    ...
    public void ctor() {
        ...
        FarmAnimal anima = new Owl(pos, map, 10, 11);
    ...
    public void produceProduct() {
        ...
        anima.tick();
        assertEquals(Product.Category.OWLEGG, anima.produceProduct(FarmAnimal.Action.INTERACT).getCategory());
    }
    ...
    public void makeNoise() {
        ...
        Matrix<Cell> map = new Matrix<Cell>(10, 11, new Coop());
        FarmAnimal anima = new Owl(pos, map, 10, 11);
        assertEquals("ho~ ho~", anima.makeNoise());
    }
